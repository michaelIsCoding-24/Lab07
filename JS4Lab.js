 ...
 * ↓ YOUR CODE HERE ↓ */
const food = 'Pizza';
const drink = 'Diet Cola';
let myName = 'Michael';
let friendName = 'Paul';

//Question: Name a reason why you would use const instead of let.
//Answer: const variables can not be altered. 
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`My name is ${myName}, and I'm inviting my friend ${friendName} over for some ${food} and ${drink}!`);
...
//Answer: console.log('My name is ' + myName + " and I'm inviting my friend " + friendName + ' over for some ' + foodChoice + ' and ' + drinkChoice + '!');
console.log(`-------------------------- 
Question 2a: Oh no`)
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
// rather than changing the previous drink const into a 'let', I altered the main const so it couldn't be altered in the future. 
console.log(drink);
//Question: Read the error message - in your own words - what does it mean?
//Answer: I tried to change a constant variable, which is a big no no. 
...
const lunchTime = (foodChoice, drinkChoice) => `My name is ${myName}, and I'm inviting my friend ${friendName} over for some ${foodChoice} and ${drinkChoice}!`;

console.log(lunchTime('Pizza','Water'))
//Question: What would your function look like if we were using the old way of creating a function?
//Answer: Like this ↓
function lunch(foodChoice, drinkChoice){
   return `My name is ${myName}, and I'm inviting my friend ${friendName} over for some ${foodChoice} and ${drinkChoice}!`;
}
/*---------------------------------- Callbacks -------------------------------------*/
console.log(`-------------------------- 
...
console.log(foodForTodayAndTomorrow('Ham', 'Milk', lunchTime(food, drink)));
